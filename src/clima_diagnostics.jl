...
import ..Interpolators:
    interpolate_to_pfull_coords!, update!, interpolate_to_pfull_coords!!
...
function compute_field(
    ...
    update!(z_sampling_method.pfull_intp, Y, p, t)
    dest = interpolate_to_pfull_coords!(field, z_sampling_method.pfull_intp)
    return dest
end
...
function compute_field!(
    ...
    update!(pfull_intp, Y, p, t)
    interpolate_to_pfull_coords!!(dest, field, pfull_intp)
    return nothing
end
