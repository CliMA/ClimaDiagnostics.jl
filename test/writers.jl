...
@testset "NetCDFWriter: initialize variable" begin
    ...
    NCDatasets.Dataset(joinpath(output_dir, "init_test.nc"), "c") do nc
        ...
        v, temporal_size = Writers.init_var_maybe!(
            nc,
            Float32,
            writer,
            [1],
        ...
        var, temporal_size = Writers.init_var_maybe!(
            nc,
            Float32,
            writer,
            [2],
        ...
        # No time values are added, since last call to init_var_maybe!
        @test temporal_size == 0

        @test_throws ErrorException Writers.init_var_maybe!(
            nc,
            Float32,
            writer,
            [1, 2],
